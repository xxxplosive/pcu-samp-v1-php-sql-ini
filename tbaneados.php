...
<body id="top">
       ...
       <div class=container>
        ...
        <p><h4>Se encuentra visualizando: <a href="#" class="btn btn-sm btn-info">USUARIOS BANEADOS</a> | <a href="index.php" class="btn btn-primary btn-success">VOLVER INICIO</a></h4> 
        <p>   </div>
...
<div class="oaerror agustinprs" id="actualizado">
    <h5><img src="images/icons2/icons8-stack-48.png"  width="13" height="13"> BASE DE DATOS: VER LOGS USUARIOS BANEADOS</h5>
<hr>
<textarea cols=180>
<?php
$archivo = fopen ("ftp://73_12568:E5exTvr3HdeUag2PNWyIYp@51.77.235.101/scriptfiles/Registros/Baneados.log", "r");
if (!$archivo) {
