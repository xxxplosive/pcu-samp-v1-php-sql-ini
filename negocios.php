...
<body id="top">
       ...
       <div class=container>
        ...
        <p><h4>Se encuentra visualizando: <a href="#" class="btn btn-sm btn-info">TODOS NEGOCIOS BD SAMP GS:RP.ES</a> | <a href="index.php" class="btn btn-primary btn-success">VOLVER INICIO</a></h4> 
        <p>   </div>
...
<div class="oaerror agustinprs" id="actualizado">
    <h5><img src="images/icons2/icons8-stack-48.png"  width="13" height="1387"> BASE DE DATOS: LISTADO DE NEGOCIOS DEL SERVIDOR</h5>
<hr>
...
$file_list = ftp_nlist($ftp_conn, "scriptfiles/Negocios");
